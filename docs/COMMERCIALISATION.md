...
| P0                   | Prévention des abus et quotas              | Limites d'inscription et de connexion par identité et réseau, quotas d'imports/stockage/exports appliqués côté serveur, nettoyage vérifié des uploads signés non finalisés ; alertes en cas de pic. Le bucket d'upload de 5 Mio est en place, mais ne règle pas les uploads orphelins.                                                     | Politique commerciale des quotas et accès aux métriques Vercel/Supabase.                                                    |
...
2. **Traitement asynchrone durable** : worker hébergé, progression et reprise après arrêt ; seulement ensuite relever la limite de 5 Mio / 50 000 lignes. Critère : une tâche interrompue reprend sans doublon ni résultat partiel exposé.
